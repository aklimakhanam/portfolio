...
**Independent Project | SQL | 2025**
<ul>
<li style="text-align: justify;">Cleaned and structured a 16-year (2007–2022) global life expectancy dataset covering 193 countries using SQL, resolving duplicate country–year records and imputing missing values with window functions and self-joins.</li>
<li style="text-align: justify;">Performed exploratory and time-series analysis to examine life expectancy trends across countries and over time.</li>
<li style="text-align: justify;">Analyzed relationships between life expectancy, adult mortality rates, GDP, BMI, and development status.</li>
</ul>    
